...
var lodash_mergewith = {
  get exports(){ return lodash_mergewithExports; },
  set exports(v){ lodash_mergewithExports = v; },
};
...
var pseudoSelectors = {
  ...
  _groupHover: toGroup(state$1.hover),
  _peerHover: toPeer(state$1.hover),
  _groupFocus: toGroup(state$1.focus),
  _peerFocus: toPeer(state$1.focus),
  _groupFocusVisible: toGroup(state$1.focusVisible),
  _peerFocusVisible: toPeer(state$1.focusVisible),
  _groupActive: toGroup(state$1.active),
  _peerActive: toPeer(state$1.active),
  _groupDisabled: toGroup(state$1.disabled),
  _peerDisabled: toPeer(state$1.disabled),
  _groupInvalid: toGroup(state$1.invalid),
  _peerInvalid: toPeer(state$1.invalid),
  _groupChecked: toGroup(state$1.checked),
  _peerChecked: toPeer(state$1.checked),
  _groupFocusWithin: toGroup(state$1.focusWithin),
  _peerFocusWithin: toPeer(state$1.focusWithin),
  _peerPlaceholderShown: toPeer(state$1.placeholderShown),
...
function useCheckbox(props = {}) {
  ...
  const [isFocusVisible, setIsFocusVisible] = reactExports.useState(false);
...
function Register() {
    var _this = this;
    var _a = reactExports.useState(false), showPass = _a[0], setShowPass = _a[1];
    var _b = reactExports.useState(false), showPassword = _b[0], setShowPassword = _b[1];
    ...
    var signUp = function () { return __awaiter(_this, void 0, void 0, function () {
        var signUpWithEmailUrl, signUpResponse, createUserEndpoint;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    signUpWithEmailUrl = "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=".concat(process.env.REACT_APP_FIREBASE_API_KEY);
                ...
                case 1:
                    ...
                    createUserEndpoint = "".concat(process.env.REACT_APP_SERVER_ENDPOINT, "/user/createUserCollection");
                    return [4 /*yield*/, axios$1({
    ...
    return (React.createElement(Container, { maxW: "lg", height: "2xl", py: { base: "0", md: "8" }, px: { base: "0", sm: "8" } },
        React.createElement(Stack, { align: "center" },
            React.createElement(Heading, { fontSize: "4xl", textAlign: "center" },
                React.createElement(Box, { display: "flex", justifyContent: "center" }),
                React.createElement(Text, { my: 2 }, "Sign up"))),
        React.createElement(Box, { py: {
                base: "0",
                sm: "8",
            }, px: {
                base: "4",
            ...
            React.createElement(Stack, null,
                React.createElement(HStack, null,
                    React.createElement(Box, null,
                        React.createElement(FormControl, { id: "firstName", isRequired: true },
                            React.createElement(FormLabel, null, "Full Name"),
                            React.createElement(Input, { type: "text", name: "name", onChange: onChange }))),
                    React.createElement(Box, null,
                        React.createElement(FormControl, { id: "lastName", isRequired: true },
                            React.createElement(FormLabel, null, "Username"),
                            React.createElement(Input, { type: "text", name: "tempUsername", onChange: onChange })))),
                React.createElement(FormControl, { id: "email", isRequired: true },
                    React.createElement(FormLabel, null, "Email address"),
                    React.createElement(Input, { type: "email", name: "email", onChange: onChange })),
                React.createElement(FormControl, { id: "register_password", isRequired: true },
                    React.createElement(FormLabel, null, "Password"),
                    React.createElement(InputGroup, null,
                        React.createElement(Input, { type: showPassword ? "text" : "password", name: "password", onChange: onChange }),
                        React.createElement(InputRightElement, { h: "full" },
                ...
                React.createElement(FormControl, { id: "confirm_password", isRequired: true },
                    React.createElement(FormLabel, null, "Confirm Password"),
                    React.createElement(InputGroup, null,
                        React.createElement(Input, { type: showPass ? "text" : "password", name: "confirm_password", onChange: onChange }),
                        React.createElement(InputRightElement, { h: "full" },
                            React.createElement(Button, { variant: "ghost", onClick: function () { return setShowPass(function (showPass) { return !showPass; }); } }, showPassword ? React.createElement(ViewIcon, null) : React.createElement(ViewOffIcon, null)))),
                    React.createElement(Flex, { justifyContent: "flex-end", alignItems: "center", mt: 3 },
                        React.createElement(Text, { mr: 3 }, "Merchant Account"),
                        React.createElement(Switch, { id: "Merchant Account", onChange: function () {
                                return setState(__assign(__assign({}, state), { isMerchant: !state.isMerchant }));
                            } }))),
                React.createElement(Stack, { spacing: 10, pt: 2 },
                    React.createElement(Button, { loadingText: "Submitting", size: "lg", bg: "blue.400", color: "white", _hover: {
                            bg: "blue.500",
